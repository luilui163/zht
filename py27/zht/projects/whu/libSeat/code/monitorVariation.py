...
class Seat:
    ...
    def _buildPath(self):
        if not os.path.exists(self.path):
            os.makedirs(os.path.join(self.path,'available'))
            os.makedirs(os.path.join(self.path,'current'))
    ...
    def getSeatInfo(self):
        ...
        dfInfo.to_csv(os.path.join(self.path,'available','%s.csv'%datetime.now().strftime('%Y%m%d-%H%M%S')))
        return dfInfo
