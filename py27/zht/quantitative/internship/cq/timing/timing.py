...
#    date=open(r'/home/hzhang/tmp/timing_tmp.txt').read()
#    print date
    d1=datetime.datetime.now()
    d2=d1+datetime.timedelta(days=-1)
    date=datetime.datetime.strftime(d2,'%Y%m%d')
    day_paths=get_paths(input_dir)
    dates=[p[-8:] for p in day_paths]
#    f=open(r'/home/hzhang/tmp/timing_tmp.txt','w')
...
if __name__=='__main__':
    daily_produce(file_dir=r'/dat/cqdata/marketdata/bloomberg',timing_dir=r'/home/hzhang/timing_test')
#    daily_produce(file_dir=r'C:\Users\Administrator\Desktop\bloomberg',timing_dir=r'c:\garbage\sadlgj')
