...
#############################################################################################################################################
    ...
    returns.to_csv(r'c:\earning_calendar\relative\test\returns.csv')
    std=returns.std()
...
#    avg=returns.mean()
    ...
    fig.savefig(r'C:\earning_calendar\relative\test\%s_%s\%d_%d.png'%(time_model,trade_model,length,days))
