...
content=open(r'C:\Users\hp\Desktop\2004-2009\raw_data1.txt').read()
content=content.replace('\n\n','\n')
with open(r'C:\Users\hp\Desktop\2004-2009\raw_data2.txt','w') as f:
    f.write(content)

import re
pat=re.compile('\d\d\d\d\d\d')
lines=open(r'C:\Users\hp\Desktop\2004-2009\raw_data2.txt').read().split('\n')[:-1]
valid_lines=[]
for line in lines:
...
with open(r'C:\Users\hp\Desktop\2004-2009\raw_data3.txt','w') as f:
