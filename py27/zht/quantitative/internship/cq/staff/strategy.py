# -*- coding: utf-8 -*-
"""
Created on Wed Aug 03 16:31:39 2016
...
number_df=pd.read_csv(R'c:\cq\staff\number_annual.csv',index_col=0)
number_growing_df=(number_df-number_df.shift(1))/number_df.shift(1)
factor=number_growing_df
...
new_alpha=[a for a in new_alpha if a[0] in stocks]
...
fig.savefig(r'C:\cq\staff\fig\staff_number_new.png')
