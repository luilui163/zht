...
def getHoldReturnDF(holdDayList,adjustedReturnDataFrame,ipoStockList,dateList,length):
    ...
    return holdReturnDF
holdReturnDF=getHoldReturnDF(holdDayList,adjustedReturnDataFrame,ipoStockList,dateList,length=15)
...
valueVariationDF=getValueVariationDF(holdDayList,adjustedIpoStockPriceDataFrame,ipoStockList,length=15)
