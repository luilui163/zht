...
class Event(object):
    '''
    Event is base class providign an interface for all subsequenet
...
class OrderEvent(Event):
    ...
    def __init__(self,symbol,order_type,quantity,direction):
        '''
        Initialises the order type,setting whether it is a
        Market order('MKT') or Limit order('LMT'),has
        a quantity (integral) and its direction('BUY' or 'SELL').

        Parameters:
        symbol - The instrument to trade
        order_type - "MKT" or 'LMT' for Market or Limit
        quantiqy - Non-negative integer for quantity.
...
class FillEvent(Event):
    ...
    actually filled an at what price.In addition,stores the
    commission of the trade from the brokerage.
    '''
    def __init__(self,timeindex,symbol,exchange,quantity,direction,
        ...
        it based on th trade size and Interactive Brokers fees.
