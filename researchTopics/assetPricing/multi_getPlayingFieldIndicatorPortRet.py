#-*-coding: utf-8 -*-
#author:tyhj
#multi_getPlayingFieldIndicatorPortRet.py 2017/9/17 16:26
...
def func(fns):
    for fn in fns:
        portId = pd.read_csv(os.path.join(indid10p, fn), index_col=0)
        portId = portId.T
        ...
        portRet.to_csv(os.path.join(iprp, fn))

if __name__=='__main__':
    fns = os.listdir(indid10p)
    multiNum=3
