...
def get_df(tbname,varname,indname,colname,fn):
    '''
...
def get_stockRetD():
    ...
    colname='Stkcd'
    fn='stockRetD'
    get_df(tbname,varname,indname,colname,fn)
...
#wind data------------------------------------------------------
def clear_data_from_wind_cg(name,freq):
...
def get_bps_wind():
    ...
    :return:
    '''
    clear_data_from_wind_cg('bps',freq='M')
