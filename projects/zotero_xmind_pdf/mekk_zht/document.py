...
SHAPE_UNDERLINE='org.xmind.topicShape.underline'
...
class Topic(DocumentPart):
    ...
    def add_subtopic(self, subtopic_title, 
        ...
        #Trick: to add other attrib for title, edit at this place
        self.doc.create_child(subtopic_tag, u"title",attrib={'width':'500'}).text = subtopic_title
    ...
    def add_marker(self, marker):
        ...
        marker : string
             Either name of one of the predefined XMind markers
             (one of the constants in `ALL_MARKS`), or hashed string
             which identifies custom marker from embedded markers
             (see XMindDocument.embed_markers)
        """
...
class TopicStyle(object):
    ...
    def create(cls, doc,
        ...
        shape : string (optional)
            Shape (SHAPE_RECTANGLE, SHNAPE_ROUND_RECTANGLE or SHAPE_ELLIPSIS or
            SHAPE_UNDERLINE)
        ...
        if fill:
            doc.create_child(style_tag, "topic-properties",
                             attrib = {
                                 ...
                                 ns_name('fo','color'):font_color,
                                 # ns_name('fo','font-size'):'20pt',
                                 # you can add other attr at this place
                              })
        else:
            doc.create_child(style_tag, "topic-properties",
                             attrib={
