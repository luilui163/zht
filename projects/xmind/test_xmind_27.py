...
# TIME:2018-07-01  21:13
# NAME:zht-test_xmind_27.py

import xmind
from xmind.core import workbook,saver
from xmind.core.topic import TopicElement

w = xmind.load(r"e:\a\test.xmind") # load an existing file or create a new workbook if nothing is found
...
xmind.save(w,r"e:\a\test2.xmind") # and we save
